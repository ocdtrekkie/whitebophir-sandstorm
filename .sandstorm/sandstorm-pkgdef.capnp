...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "rhtntjye2n7p71vrcq0ae4f6n9nr139fdk4n884tw55k40vy4uph",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "whiteboard"),
        command = .myCommand
    ...
    metadata = (
      icons = (
        appGrid = (svg = embed "../whitebophir/client-data/favicon.svg"),
        grain = (svg = embed "../whitebophir/client-data/favicon.svg"),
        market = (svg = embed "../whitebophir/client-data/favicon.svg"),
        marketBig = (svg = embed "../whitebophir/client-data/favicon.svg"),
      ),
  ...
  alwaysInclude = ["usr/lib/node_modules/npm/node_modules/node-gyp"],
